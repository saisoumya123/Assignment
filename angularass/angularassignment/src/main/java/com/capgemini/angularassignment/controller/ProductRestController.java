...
public class ProductRestController {
	...
	@DeleteMapping(path="/deleteProduct/{proName}",
			produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
	public ProductResponse deleteProduct(@PathVariable(name="proName") String proName) {

		boolean isDeleted = service.deleteProductInfo(proName);
